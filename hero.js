(() => {
  ...
  function Hero({ data, onCopy, heroVariant }) {
    return /* @__PURE__ */ React.createElement("section", { className: "pg-hero pg-rise", "data-screen-label": "Hero" }, /* @__PURE__ */ React.createElement(HeroDeco, null), /* @__PURE__ */ React.createElement("div", { className: "pg-hero__l" }, /* @__PURE__ */ React.createElement("span", { className: "pg-hero__eyebrow" }, /* @__PURE__ */ React.createElement(IconGift, { size: 14 }), " Refer & earn"), /* @__PURE__ */ React.createElement("h1", null, "Invite friends, ", /* @__PURE__ */ React.createElement("br", null), "get ", /* @__PURE__ */ React.createElement("span", { className: "hl" }, "free lessons")), /* @__PURE__ */ React.createElement("p", { className: "pg-hero__sub" }, "Free lessons for you, a welcome gift for your friend. No limits."), /* @__PURE__ */ React.createElement("div", { className: "pg-hero__rewards" }, /* @__PURE__ */ React.createElement("div", { className: "pg-reward-tile" }, /* @__PURE__ */ React.createElement("span", { className: "pg-reward-tile__who" }, "You get"), /* @__PURE__ */ React.createElement("span", { className: "pg-reward-tile__val" }, "Free lessons"), /* @__PURE__ */ React.createElement("span", { className: "pg-reward-tile__sub" }, "1 per trial \xB7 a free month per subscriber")), /* @__PURE__ */ React.createElement("div", { className: "pg-reward-tile" }, /* @__PURE__ */ React.createElement("span", { className: "pg-reward-tile__who" }, "Your friend gets"), /* @__PURE__ */ React.createElement("span", { className: "pg-reward-tile__val" }, "A welcome discount"), /* @__PURE__ */ React.createElement("span", { className: "pg-reward-tile__sub" }, "on their first trial lesson")))), /* @__PURE__ */ React.createElement("div", { className: "pg-hero__r" }, /* @__PURE__ */ React.createElement(ShareCard, { data, onCopy, variant: heroVariant })));
  }
